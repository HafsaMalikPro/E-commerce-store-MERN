	...
	return (
		<div className='py-12'>
			<div className='container mx-auto px-4'>
				<h2 className='text-center text-5xl sm:text-6xl font-bold text-sky-400 mb-8'>Featured</h2>
									...
									<div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border border-sky-500/30'>
										...
										<div className='p-4'>
											...
											<button
												...
												className='w-full bg-sky-700 hover:bg-sky-900 text-white font-semibold py-2 px-4 rounded transition-colors duration-300 
